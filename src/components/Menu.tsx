    ...
    <div className="menu">
      <div id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                  ...
                  <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                    <g id="Icon" transform="translate(27.000000, 15.000000)">
                      <g id="Mask" transform="translate(0.000000, 8.000000)">
                        ...
                        <use fill="#696cff" to="#path-1"></use>
                        <g id="Path-3" mask="url(#mask-2)">
                          <use fill="#696cff" to="#path-3"></use>
                          <use fill-opacity="0.2" fill="#FFFFFF" to="#path-3"></use>
                        </g>
                        <g id="Path-4" mask="url(#mask-2)">
                          <use fill="#696cff" to="#path-4"></use>
                          <use fill-opacity="0.2" fill="#FFFFFF" to="#path-4"></use>
                        </g>
                      </g>
                      <g
                        id="Triangle"
                      ...
                      >
                        <use fill="#696cff" to="#path-5"></use>
                        <use fill-opacity="0.2" fill="#FFFFFF" to="#path-5"></use>
                      </g>
                    </g>
                  </g>
                </g>
        ...
        <ul className="menu-inner py-1">
          ...
          {['SuperAdmin', 'Admin'].includes(userData?.role || '') && (
            <li className={`menu-item ${location.pathname === '/s' ? ' active' : ''} `}>
              <NavLink to="javascript:void(0)" className="menu-link ">
